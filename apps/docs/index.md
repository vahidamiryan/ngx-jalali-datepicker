...
features:
  - title: Shared headless core
    details: "All calendar math, adapters, selection and view-building live in @vahidamirian/datepicker-core — pure TypeScript, zero framework deps. Fix a bug once, both frameworks get it."
  ...
  - title: Angular & Vue, identical behavior
    details: "@vahidamirian/ngx-jalali-datepicker (signals, zoneless, OnPush) and @vahidamirian/vue-datepicker (Composition API, v-model, scoped slots) render the same UI from the same core."
